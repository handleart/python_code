...
#f = '{0:0' + '3' + 'b}'
	...
	#print len(p), len(z), len(setOfResults1)
	...
	for i in setOfResults1:
		...
		for z in tmp.keys():
			if tmp[z] == node0_k or tmp[z] == node1_k:
				tmp[z] = name
...
#print "result should be 9116"

#print "Starting Cluster"


print 'Running Using Actual Data'
